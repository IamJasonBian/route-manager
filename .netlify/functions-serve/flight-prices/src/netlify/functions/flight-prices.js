...
var flight_prices_exports = {};
__export(flight_prices_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(flight_prices_exports);
...
var flightPricesHandler = async (event, context) => {
...
var handler = withCors(flightPricesHandler);
