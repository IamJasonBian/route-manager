...
var require_package = __commonJS({
  "netlify/functions/node_modules/dotenv/package.json"(exports, module2) {
    module2.exports = {
      name: "dotenv",
      version: "16.5.0",
...
var require_main = __commonJS({
  "netlify/functions/node_modules/dotenv/lib/main.js"(exports, module2) {
    var fs = require("fs");
...
var loadEnv = () => {
  ...
  for (const envPath of envPaths) {
    try {
      const result = (0, import_dotenv.config)({ path: envPath });
      if (!result.error) {
...
var onRequest = (handler) => async (event, context) => {
