...
// ../node_modules/amadeus/lib/amadeus/namespaces/duty_of_care/diseases/covid19_report.js
var require_covid19_report = __commonJS({
  "../node_modules/amadeus/lib/amadeus/namespaces/duty_of_care/diseases/covid19_report.js"(exports2, module2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", {
      value: true
    });
...
var require_diseases = __commonJS({
  "../node_modules/amadeus/lib/amadeus/namespaces/duty_of_care/diseases.js"(exports2, module2) {
    "use strict";
    function _typeof(obj2) {
      "@babel/helpers - typeof";
      return _typeof = typeof Symbol == "function" && typeof Symbol.iterator == "symbol" ? function(obj3) {
...
var require_duty_of_care = __commonJS({
  "../node_modules/amadeus/lib/amadeus/namespaces/duty_of_care.js"(exports2, module2) {
    "use strict";
    function _typeof(obj2) {
      "@babel/helpers - typeof";
      return _typeof = typeof Symbol == "function" && typeof Symbol.iterator == "symbol" ? function(obj3) {
...
var generateMockPrices = (basePrice = 300) => {
  const today = new Date();
  today.setHours(0, 0, 0, 0);
  const prices = [];
  const daysInFourMonths = 120;
  for (let i = 0; i < daysInFourMonths; i++) {
    ...
    const timeVariation = Math.sin(timeProgress * Math.PI) * 0.3;
    ...
    price = Math.max(Math.round(basePrice * 0.6), Math.min(price, Math.round(basePrice * 1.8)));
...
var getSamplePrice = async (origin, destination) => {
  try {
...
var formatDuration = (isoDuration) => {
  if (!isoDuration)
    return "N/A";
...
var getFlightInfo = async (origin, destination) => {
  try {
    ...
    console.log(`Direct destinations API response for ${origin}:`, JSON.stringify(directResponse, null, 2));
    if (directResponse.data && directResponse.data.length > 0) {
      const directFlight = directResponse.data.find((flight) => flight.arrivalAirport && flight.arrivalAirport.iataCode === destination);
      if (directFlight) {
  ...
  try {
    ...
    console.log(`Flight offers search response for ${origin} to ${destination}:`, JSON.stringify(flightOffers, null, 2));
    if (flightOffers.data && flightOffers.data.length > 0) {
      ...
      if (offer.itineraries?.[0]?.segments?.[0]?.distance?.value) {
        ...
        const miles = Math.round(meters * 621371e-9);
  ...
  if (airportCoordinates[origin] && airportCoordinates[destination]) {
    const distance = calculateDistance(airportCoordinates[origin].lat, airportCoordinates[origin].lng, airportCoordinates[destination].lat, airportCoordinates[destination].lng);
...
exports.handler = async (event, context) => {
  ...
  try {
    ...
    console.log("Amadeus client configured with clientId:", amadeus.client.clientId ? "***" + amadeus.client.clientId.slice(-4) : "not set");
    const popularRoutes = [
      ...
      try {
        ...
        try {
          ...
          if (realPrices && realPrices.length > 0) {
            ...
            basePrice = Math.round(realPrices[0].price);
          ...
          if (samplePrice !== null) {
            ...
            prices = generateMockPrices(basePrice).map((p) => __spreadProps(__spreadValues({}, p), {
              price: Math.round(p.price),
              source: "sample",
              isRealPrice: false
            }));
...
//# sourceMappingURL=popular-routes.js.map
