...
ALTER FUNCTION public.update_modified_column() OWNER TO routeuser;
...
ALTER TABLE public.routes OWNER TO routeuser;
...
ALTER TABLE public.routes_id_seq OWNER TO routeuser;
